...
const NavBarCorner = (props) => {
  return (
    <div className={`nav-bar-corner-container ${props.rootClassName} `}>
      ...
      >
        <div data-thq="thq-navbar-nav" className="nav-bar-corner-desktop-menu">
          <div className="nav-bar-corner-container1">
            <nav className="nav-bar-corner-links">
              <Link to="/" className="nav-bar-corner-navlink">
                <span className="">Home</span>
                <br className=""></br>
              </Link>
              <Link to="/classes" className="nav-bar-corner-navlink1">
                Classes
              </Link>
              <Link to="/about-us" className="nav-bar-corner-navlink2">
                About Us
              </Link>
              <a
          ...
          <div className="nav-bar-corner-buttons"></div>
        </div>
        <div
          data-thq="thq-burger-menu"
          className="nav-bar-corner-burger-menu"
        ></div>
        <svg viewBox="0 0 1024 1024" className="nav-bar-corner-icon">
          <path
            d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"
            className=""
          ></path>
        </svg>
        <div data-thq="thq-mobile-menu" className="nav-bar-corner-mobile-menu">
          <div className="nav-bar-corner-nav">
            <div className="nav-bar-corner-top">
              ...
              >
                <svg viewBox="0 0 1024 1024" className="nav-bar-corner-icon02">
                  <path
            ...
            <div className="nav-bar-corner-buttons1">
              <button className="nav-bar-corner-register1 button">
                Register
              </button>
            </div>
          </div>
          <div className="">
            <svg
              ...
              className="nav-bar-corner-icon04"
            >
              <path
            ...
            <svg
              ...
              className="nav-bar-corner-icon06"
            >
              <path
            ...
            <svg
              ...
              className="nav-bar-corner-icon08"
            >
              <path
